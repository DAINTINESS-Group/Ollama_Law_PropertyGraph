...
print(json.dumps(
    [{"paragraphID": chunk.get("paragraphID", "unknown"), "text": chunk.get("text", "")[:100]} for chunk in documents],
    indent=2
))
...
dfg = (
    ...
    .agg({
        ...
        "edge": ','.join, 
        "count": 'sum',
        "paragraph_id": ','.join  # ✅ Add paragraph_id here
    })
    .reset_index()
)
